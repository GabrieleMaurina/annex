...
```ts
{
  ...
  mapGeneration: { size: MapSize; water: WaterLevel } | null; // non-null iff the map is generated; seed omitted
  hostName: string;
  playerCount: number;
  slots: number;

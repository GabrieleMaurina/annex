...
### `game:buyShips`
- **When sent:** the player whose turn it currently is, during `'deploy'`, buys one or more ships from the buy-ships control (see "Seas and ships" above).

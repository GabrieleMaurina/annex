...
export function useGameCanvasInteractions({
  ...
  return useCanvasInteractions({
    ...
    quickAttackSea: attackSeaFlow.quickAttackSea,
    ...
    quickFortify: turnFlow.quickFortify,
    ...
    quickDeploy: cardsFlow.quickDeploy,
    ...
    quickDeploySea: deploySeaFlow.quickDeploySea,
